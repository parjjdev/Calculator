      ...
      <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4 pr-[8px]  w-full bg-white rounded-2xl shadow">
        <div className="flex items-center justify-between w-full md:w-auto">
          ...
          >
            ...
            >
              <g clip-path="url(#clip0_28_13264)">
                <path
        ...
        >
          ...
          {isMobileMenuOpen && (
            <button className="flex items-center justify-center bg-green-500 text-white bg-gradient-to-r from-[#5AC57B] to-[#15B146] rounded-lg px-5 py-2 shadow font-medium text-sm hover:bg-green-600 transition-all">
              Contact us
              <svg
        ...
        {!isMobileMenuOpen && (
          <div className="hidden md:flex items-center justify-center ml-2">
            <Link to="/contactForm"  className="flex items-center justify-center bg-green-500 text-white bg-gradient-to-r from-[#5AC57B] to-[#15B146] rounded-lg px-5 py-2 shadow font-medium text-sm hover:bg-green-600 transition-all">
              Contact us
              <svg
                className="ml-2 h-4 w-4"
                viewBox="0 0 16 17"
